(function(global) {
	...
	function Promise(fn) {
		...
		this.then = function(onFulfilled, onRejected) {
			...
			if (state === States.fulfilled && typeof onFulfilled === "function") {
				fulfill(valueOrReason);
			}
			else if (state === States.rejected && typeof onRejected === "function") {
						...
						if (cacheElement["on" + actionType]) {
							...
							(function(ce) {
								callAsap(function() {
									var value;
									try {
										value = ce["on" + actionType].call(this, valueOrReason);
