(function(global) {
		...
		try {
			...
			callAsap = function(cb) {
				...
				window.setTimeout(function() {
					cb.apply(self /*figure out what the this val should be*/ , [].slice.call(args, 1));
				}, 0);
			};
		}
	...
	Promise.reject = function(reason) {
		var prom = new Promise(function(f,r){
			r(reason);
		});
		return prom;
	};
