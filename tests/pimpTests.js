...
describe("pimp", function() {
  ...
  describe("#all", function() {
    ...
    it("should throw when it is called with non-array param or empty array",function(){
      Pimp.all.bind(null,"test").should.throw("Pimp.all needs to be passed an array");
      Pimp.all.bind(null,[]).should.throw("Pimp.all needs an array of length >= 1");
      Pimp.all.bind(null,[1,"test",false]).should.not.throw();
    });
  });
  describe("#allFail", function() {
    ...
    it("should throw when it is called with non-array param or empty array",function(){
      Pimp.allFail.bind(null,"test").should.throw("Pimp.allFail needs to be passed an array");
      Pimp.allFail.bind(null,[]).should.throw("Pimp.allFail needs an array of length >= 1");
      Pimp.allFail.bind(null,[1,"test",false]).should.not.throw();
    });
  });
  describe("#race", function() {
    ...
    it("should throw when it is called with non-array param or empty array",function(){
      Pimp.race.bind(null,"test").should.throw("Pimp.race needs to be passed an array");
      Pimp.race.bind(null,[]).should.throw("Pimp.race needs an array of length >= 1");
      Pimp.race.bind(null,[1,"test",false]).should.not.throw();
    });
  });
  ...
  describe("#denodeify", function() {
    ...
    it("should throw when it is called with a non-function parameter",function(){
      Pimp.denodeify.bind(null,"test").should.throw("Pimp.denodeify needs to be passed a function to promisify");
      Pimp.denodeify.bind(null,function(){console.log("boop");}).should.not.throw();
    });
