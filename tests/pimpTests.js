...
if ((PIMP_LIB_DIR.split("/")[1] === "lib")) {
  ...
  console.log("  <p style='margin:10px 60px;display: inline-block;margin-top: 15px;border: 1px solid #EEE; \
              ...
              border-radius: 5px;color: #1BA2D6;font-size: 1.2em;'>Using wrap.js and pimp.js from: " + PIMP_LIB_DIR.split("/").splice(0,2).join("/") + "</p>");
}
